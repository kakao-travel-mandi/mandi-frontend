...
const tabData = [
  {id: 1, title: '홈', icon: <Home />, url: PATHNAME.HOME},
  {id: 2, title: '코스', icon: <Course />, url: PATHNAME.COURSE},
  {id: 3, title: '스크랩', icon: <Scrap />, url: PATHNAME.SCRAP},
  {id: 4, title: '랭킹', icon: <Ranking />, url: PATHNAME.RANKING},
  {id: 5, title: '내정보', icon: <User />, url: PATHNAME.MY_INFO},
];
